...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public void createMessage(String message, Long authorId, Long roomId) {
    ...
    @Override
    public Optional<Message> findLastRoom(Long authorId) {
        return messageRepository.findLastRoomByAuthor(authorId);
    }
